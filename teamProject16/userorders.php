    ...
    <div class="navbar">
        ...
        <ul>
            <li>
                ...
                <form method="POST" action="userorders.php" class="Form-Container">
                    <input class="searchTerm" type="text" name="SearchPastOrder" placeholder="Enter E-mail to view orders">
                    <button class="searchButton" type="submit"> <i class="fa fa-search fa-1x"></i> </button>
