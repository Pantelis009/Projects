        ...
        <ul>
            <li>
                ...
                <form method="POST" action="basicWeb.php" class="Form-Container">
                    <input class="searchTerm" type="text" name="criteria" placeholder="Search for an item!">
            ...
            <div class="vidbox">
                <div class="card">
                    ...
                    <div class="caption">
                            ...
                            <h2 style="text-align:center;">£<?php echo $row['price']; ?></h2>
                            <h2 style="text-align:center;"><?php echo $row['information']; ?></h2>
